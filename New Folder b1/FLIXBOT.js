...
let audio = {
    ...
    contextInfo: {
      externalAdReply: {
        ...
        body: 'SALAM',
        sourceUrl: '',
        thumbnail: await (await Fernazerini.getFile('https://k.top4top.io/p_3249y8ta43.jpg')).data,
  ...
  let verif = {
            ...
            { remoteJid: "6281250431837-1625305606@g.us" } : {}) 
                       },
            message: {
                conversation: `_kyami Terverifikasi Oleh WhatsApp_`
            }
        }
...
console.log('\x1b[1;31m~\x1b[1;37m>', '[\x1b[1;32m 𝘏𝘶𝘛𝘰𝘶-𝘔𝘋 \x1b[1;37m]', time, chalk.green(budy || m.mtype), 'Dari', chalk.blue(pushname), 'Di', chalk.yellow(groupName ? groupName : 'Private Chat' ), 'args :', chalk.white(args.length))
            }
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          ...
          nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
            buttonParamsJson: [
            {
              ...
              {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"YOUTUBE\",\"url\":\"https://youtube.com/@Cannnxy\",\"merchant_url\":\"https://www.google.com\"}"
              },              
              {
                 "name": "cta_url",
          ...
          contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                  newsletterJid: '120363329561414919@newsletter',
...
case 'socialmedia': 
    ...
    [
        ...
        'https://youtube.com/@Cannxy', // Command (URL in this case)
        'cta_url', // Button type
        'https://youtube.com/@Cannxy' // URL (used in image generation)
    ], 
    [
        ...
        botname, // Footer message
        'Visit', // Button display text
        'http://t.me/slnckyami', // Command (URL in this case)
        'cta_url', // Button type
        'http://t.me/inventorykyami' // URL (used in image generation)
    ], 
    [
    ...
    [
        ...
        botname, // Footer message
        'Visit', // Button display text
        'https://www.instagram.com/kyamicuy', // Command (URL in this case)
        'cta_url', // Button type
        'https://www.instagram.com/kyamicuy' // URL (used in image generation)
    ], 
    [
...
"mediaUrl": `https://k.top4top.io/p_3249y8ta43.jpg`,
...
anyone like it? please upgrade Premium User to owner`
  Fernazerini.sendMessage(from, { image: { url: "https://k.top4top.io/p_3249y8ta43.jpg" }, caption: teks28 }, { quoted: fcall })
}
...
break
case 'sc': case 'script': {
tut = `Kakak Bisa Mendownload Script ini Secara Gratis Di Channel YouTube slnckyami`
...
Jika Ingin Menyewa 𝘏𝘶𝘛𝘰𝘶-𝘔𝘋 Silahkan Ketik .pembayaran 
`)
}
break
case 'delprem': {
...
break
case "bcimg": {
if (!isCreator) return reply(`ᴋʜᴜsᴜs kyami ᴅᴏᴀɴᴋ ʟᴏʟ`)
...
break
case 'restart':
if (!isCreator) return reply('ᴋʜᴜsᴜs kyami ᴅᴏᴀɴᴋ')
reply(`ᴍʀᴇsᴛᴀʀᴛ kyami....`)
await sleep(3000)
process.exit()
break
case 'runtime': {
...
break
case 'delcase': {
if (!isCreator) return reply(`ᴋʜᴜsᴜs kyami ᴀᴊ ʟᴏʟ`)
...
break
case "listgc":{
if (!isCreator) return (`ᴋʜᴜsᴜs kyami ᴀᴋ ʟᴏʟ ᴡᴋᴡᴋ`)
let getGroups = await Fernazerini.groupFetchAllParticipating()
let groups = Object.entries(getGroups).slice(0).map((entry) => entry[1])
let anu = groups.map((v) => v.id)
let hituet = 0
...
break
case 'antilink': {
if (!isCreator) return reply('*khusus kyami*')
...
reply('𝘏𝘶𝘛𝘰𝘶-𝘔𝘋 SUKSES MODE PUBLIC')
}
break
case 'self': {
if (!isCreator) return mess.owner
...
if (!isPrem && global.db.data.users[sender].limit < 1) return reply('Maaf Kak Limit Anda Habis Ingin Membeli Limit Ketik .buylimit')
             db.data.users[sender].limit -= 1 // -1 limit
                reply('1 Limit Anda Terpakai')
if (!text) return reply(`ʟɪɴᴋ ɴʏ ᴍɴ ʙɪᴀʀ kyami ᴘʀᴏsᴇs`)
let old = new Date()
...
{
"externalAdReply": {
"title": 'sᴘᴏᴛɪғʏ ʙʏ kyami',
"body": `kyami`,
"showAdAttribution": true,
"mediaType": 1,
"sourceUrl": '',
"thumbnailUrl": 'https://k.top4top.io/p_3249y8ta43.jpg',
"renderLargerThumbnail": true
}
}}, {quoted: fcall})
...
let teks = m.quoted ? quoted.text : text
 try {
   try {
                    ...
                    pic = 'https://k.top4top.io/p_3249y8ta43.jpg'
                }
         const obj = {
            "type": "quote",
            "format": "png",
...
Done Bwang Kuhhh Kamu Sekarang Sudah Bisa Mengakses 𝘏𝘶𝘛𝘰𝘶-𝘔𝘋 Abangkuhh Btw Limit Gada Reset Reset an Jika Limit Habis Silahkan Buy Limit Di kyami`
veri = m?.sender
if (!m.isGroup) {
...
if (!isCreator) return reply(mess.owner) 
Fernazerini.public = true
reply('SUCCES PUBLIC KAK kyami')
}
break
case 'self': {
if (!isCreator) return reply(mess.owner) 
Fernazerini.public = false
reply('SUCCES SELF KAK kyami')
}
break
...
break
      ...
      case "listsw": {
        ...
        break;
case 'emojimix': { 
if (isBan) return m.reply('ʟᴜ ᴅɪ ʙᴀɴ ᴏʟᴇʜ kyami')
await loading()
...
break 
        case 'group': {   
if (!isCreator) return m.reply('ᴋʜᴜsᴜs kyami')
if (!m.isGroup) return m.reply('ᴋʜᴜsᴜs ɢʀᴏᴜᴘ')
...
Fernazerini.sendMessage(m.chat, { image: ppnyauser, caption: `ᴄᴏɴᴛᴏʜ ; .kyami ᴛᴜᴛᴜᴘ ɢʀᴏᴜᴘ
ᴄᴏɴᴛᴏʜ : .kyami ʙᴜᴋᴀ ɢʀᴏᴜᴘ`}, {quoted:m}) 
 }
}
break
case "antitoxic":
...
case '1gb': {
        if (!isPrem) return reply(`ᴋʜᴜsᴜs kyami`)
...
akunlo = "https://k.top4top.io/p_3249y8ta43.jpg" 
if (!u) return
...
break
case "2gb": {
    if (!isPrem) return reply(`Anda Belum Menjadi Reseler Beli Reseler Skrng Di kyami agar Bisa Mengakses Fitur Cpanel`)
...
break
case "8gb": {
if (!isPrem) return reply(`ʙᴜʏ ᴘʀᴇᴍ ᴅʟᴜ ᴅɪ kyami`)
let t = text.split(',');
if (t.length < 2) return reply(`*Format salah!*
Penggunaan:
${prefix + command} user,nomer`)
...
let msg = generateWAMessageFromContent(m.chat, {
 ...
 forwardedNewsletterMessageInfo: {
 newsletterJid: '120363329561414919@newsletter',
 newsletterName: 'Powered By kyami', 
 serverMessageId: -1
},
 ...
 title: `ʙᴜʏ ᴘᴀɴᴇʟ ʀᴇᴋ`,
 subtitle: "dcdXdino",
 hasMediaAttachment: true,...(await prepareWAMessageMedia({ image: { url: "https://k.top4top.io/p_3249y8ta43.jpg" } }, { upload: Fernazerini.waUploadToServer }))
 }),
 nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
 buttons: [ 
 {
...
break
case "detusr": {
if (!isCreator) return reply(`*Anda Belum Menjadi Reseler Beli Reseler Skrng Di kyami agar Bisa Mengakses Fitur Cpanel!*`)
let usr = args[0]
...
break
case "listsrv": {
  if (!isCreator) return reply(`ᴋʜᴜsᴜs kyami.`);
...
let msg = generateWAMessageFromContent(m.chat, {
 ...
 header: proto.Message.InteractiveMessage.Header.create({
 title: Styles(`ʙᴜʏ ᴘᴀɴᴇʟ ᴅ kyami ʏᴏᴋ`),
 subtitle: "dcdXdino",
 hasMediaAttachment: true,...(await prepareWAMessageMedia({ image: { url: "https://k.top4top.io/p_3249y8ta43.jpg" } }, { upload: Fernazerini.waUploadToServer }))
 }),
 nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
...
case 'tutorial': {
await loading()
tut = `ᴛᴜᴛᴏʀ ʀᴜɴ ᴘᴀɴᴇʟ ʙʏ cann
https://youtube.com/@Cannnxy`
await Fernazerini.relayMessage(m.chat,  {
requestPaymentMessage: {
currencyCodeIso4217: 'IDR',
amount1000: 1000000000,
...
case 'backup':
        {
          if (!isCreator) return reply(mess.owner)
     await reply("ᴡᴀɪᴛ ʙᴀᴄᴋᴜᴘ sᴄ hutou ᴠ4.5");
...
case "linode8gb": {
  if (!isCreator) return reply(`Khusus kyami Saja Suki`);
  try {
    let linodeData = {
      label: `${args[0]}`,
...
𝗧𝗲𝗿𝗶𝗺𝗮𝗸𝗮𝘀𝗶𝗵 𝗧𝗲𝗹𝗮𝗵 𝗢𝗿𝗱𝗲𝗿 𝗗𝗶 𝙆𝙔𝘼𝙈𝙄 𝙄𝙉 𝙃𝙀𝙍𝙀
...
Itulah Rules 𝘏𝘶𝘛𝘰𝘶-𝘔𝘋 Kak Jangan Langgar Ya Kak`)
             await Fernazerini.sendMessage(m.chat, {audio: fs.readFileSync('./Vn/rulesy.mp3'),mimetype: 'audio/mpeg',ptt: true}, {quoted:m})}
             break
             case 'formatneed': {
             reply(`*FORMAT NEED AKUN BY 𝙆𝙔𝘼𝙈𝙄 𝙄𝙉 𝙃𝙀𝙍𝙀*
_NOTE!!! : INI BUKAN 100% AKUN MILIK ADMIN ATAU 𝙆𝙔𝘼𝙈𝙄 𝙄𝙉 𝙃𝙀𝙍𝙀 TETAPI AKUN MILIK SELER!!!_
...
_JANGAN LUPA SLALU MENGGUNAKAN JASA ADMIN 𝙆𝙔𝘼𝙈𝙄 𝙄𝙉 𝙃𝙀𝙍𝙀 AGAR TERHINDAR DARI PENIPUAN ATAU MODUS LAINNY_`)
}
break
case 'formatjp': {
reply(`*FORMAT JASA PSOT AKUN BY 𝙆𝙔𝘼𝙈𝙄 𝙄𝙉 𝙃𝙀𝙍𝙀*
...
break
case 'feerekber': {
reply(`ALL FEE REKBER DI 𝙆𝙔𝘼𝙈𝙄 𝙄𝙉 𝙃𝙀𝙍𝙀 HANYA 5K`)
}
break
case 'feegc': {
reply(`langsung culik 𝙆𝙔𝘼𝙈𝙄 𝙄𝙉 𝙃𝙀𝙍𝙀`)
}
break
case 'donasi': {
teks28 = `*『 DONASI 』*
Terimakasih Telah Berdonasi Kak 𝙆𝙔𝘼𝙈𝙄 𝙄𝙉 𝙃𝙀𝙍𝙀 akan Terus Mengembangkan Bot ini Insyaallah
...
if (!isCreator) return (`Khusus kyami`)
if (args[0] == 'on'){
...
break
case 'paptt1': {
if (!isPrem) return reply(`Buy Prem Dlu Lah Di kyami Wkwk`)
...
Fernazerini.sendMessage(from, { image: { url: "https://telegra.ph/file/d8b79ac5e98796efd9d7d.jpg" }, caption: teks28 }, { quoted: fcall })
}
break
case 'paptt4': {
if (!isPrem) return reply(`Buy Prem Dlu Lah Di kyami Wkwk`)
teks28 = `SANGEAN KONTOL`
Fernazerini.sendMessage(from, { image: { url: "https://telegra.ph/file/0e5be819fa70516f63766.jpg" }, caption: teks28 }, { quoted: fcall })
}
break
case 'paptt5': {
if (!isPrem) return reply(`Buy Prem Dlu Lah Di kyami Wkwk`)
teks28 = `SANGEAN KONTL`
Fernazerini.sendMessage(from, { image: { url: "https://telegra.ph/file/af029472c3fcf859fd281.jpg" }, caption: teks28 }, { quoted: fcall })
}
break
...
Fernazerini.sendMessage(m.sender, { image: { url: yeha }, caption : '© 𝘏𝘶𝘛𝘰𝘶-𝘔𝘋 2023 - 2024'}, { quoted: m })
}
break
case 'tiktokgirl':
await loading()
...
*ɴᴏᴛᴇ* : _ᴊɪᴋᴀ ꜱᴜᴅᴀʜ ᴛʀᴀɴꜱꜰᴇʀ ꜱɪʟᴀʜᴋᴀɴ ᴋᴇᴛɪᴋ ᴄᴏɴᴛᴏʜ : .ʙᴜᴋᴛɪ Qʀɪꜱ5ᴋ ,, ᴅᴀɴ ꜱᴇʀᴛᴀᴋᴀɴ ɴᴀᴍᴀ ᴘᴇɴɢɪʀɪᴍ ᴇ-ᴡᴀʟᴇᴛ ᴄᴏɴᴛᴏʜ : ᴀᴛᴀꜱ ɴᴀᴍᴀ ᴅᴀɴᴀ : kyami ʜᴀɴʏᴀ ᴄᴏɴᴛᴏʜ ,, ᴊɪᴋᴀ ᴛɪᴅᴀᴋ ᴍᴇɴɢɪᴋᴜᴛɪ ᴛɪᴅᴀᴋ ᴀᴋᴀɴ ᴅɪ ᴘʀᴏꜱᴇꜱ_
...
_SCRIPT 𝘏𝘶𝘛𝘰𝘶-𝘔𝘋 V6_
_TYPE CASE_

BASE : HWMODS
FEATURE : 𝙆𝙔𝘼𝙈𝙄 𝙄𝙉 𝙃𝙀𝙍𝙀
PENGEMBAN : 𝙆𝙔𝘼𝙈𝙄 𝙄𝙉 𝙃𝙀𝙍𝙀
...
if (!isPrem) return reply('Khusud Prem Yang Mau Buy Prem Ke Owner')
        for (let jumbo = 0; jumbo < 80; jumbo++) {
          ...
          babuk.forwardedNewsletterMessageInfo.newsletterJid = "120363329561414919@newsletter";
...
mediaType:  1,
mediaUrl: 'https://youtube.com/@Cannnxy',
title: `Converter mp3`,
...
if ((budy.match) && ["kyami", "kyami",].includes(budy) && !isCmd) {
reply(`Hai kak Bot Kyami In Here!! ada yang bisa saya bantu?.`) 
}
